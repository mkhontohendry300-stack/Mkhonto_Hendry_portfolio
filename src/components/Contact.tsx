...
const Contact = () => {
  ...
  const contactInfo = [
    { icon: Mail, title: "Email", value: "mkhontohendry300@gmail.com", href: "mailto:mkhontohendry300@gmail.com" },
    { icon: Phone, title: "Phone", value: "+27 793003577", href: "tel:+27793003577" },
