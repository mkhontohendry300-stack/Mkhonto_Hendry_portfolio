        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-12">
            ...
            <div className="space-y-6 text-gray leading-relaxed">
              ...
              <p>Currently working at CAPACITI as a Digital Engineer, I excel in data visualization and digital transformation projects. I am driven to combine analytical precision with modern technology to solve real-world challenges.</p>
            </div>
          </div>

          {/* Highlights */}
          <div className="grid sm:grid-cols-3 gap-6">
            {highlights.map((highlight, index) => <Card key={index} className="bg-white border-gold/20 hover:shadow-soft transition-all duration-300">
